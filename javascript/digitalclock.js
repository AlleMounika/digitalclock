...
function bgImage(){
    ...
    document.body.style.backgroundImage=`url(./assets/${arrImage[dy]})`;
}
var audio=new Audio("./assets/clock-alarm-8762.mp3")
...
function userData(){
    ...
    var currentddmoyy=`${yy}-${mo}-${dd}`;
    var currentTime=`${hh}:${mm}`;
    //console.log(currentddmoyy)
    //console.log(currentTime)
    var userDate=allinp[0].value;
    //console.log(userDate);
    var userTime=allinp[1].value;
    //console.log(userTime);
    if(currentddmoyy=userDate && userTime==currentTime){
